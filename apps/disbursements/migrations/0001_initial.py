    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider_bank_code', models.CharField(max_length=150)),
                ('provider_bank_id', models.CharField(max_length=150)),
                ('provider_counterparty_id', models.CharField(max_length=150)),
                (
                    'provider',
                    models.CharField(
                        choices=[('Anchor', 'Anchor')], default='Anchor', max_length=50, verbose_name='provider'
                    ),
                ),
                (
                    'account',
